...
/**
 * The gossip message contains arbitrary data that should be propagated
 * across the network using a gossip protocol.
 */
inline constexpr const char* GOSSIP{"gossip"};
}; // namespace NetMsgType
